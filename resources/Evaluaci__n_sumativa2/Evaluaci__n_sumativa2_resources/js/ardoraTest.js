...
if (ima[indexTag].length>0){$("#ardoraChecks").css("width","235");
var newDiv = $('<div id="imaForTag" tabindex="0"></div>);');newDiv.css({height:"400px",width:"400px",position:"relative",padding: "0px",margin: "0px",float:"right"});
