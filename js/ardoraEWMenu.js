...
function do_responsiveMobile() {$("#contedorTotal").css("transform-origin", "0 0");$("#contedorTotal").css("transform", "scale(1)");$("#contedorTotal").css("margin-left","-540px");$("#contedorTotal").css("left","50%");n=1;
...
function do_responsivePC() {$("#contedorTotal").width("1080px");$("#ArdoraIframe").height("450px");$("#contedorTotal").css("transform-origin", "0 0");$("#contedorTotal").css("transform", "scale(1)");
